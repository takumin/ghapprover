...
type PrStateProblem = "head-repo-forked" | "head-repo-missing" | "pr-draft" | "pr-not-open";
...
type TrustEvaluation = "org-membership" | "trusted" | "untrusted";
...
function classifyPrincipal(user: GithubAccount, repoOwner: GithubAccount): TrustEvaluation {
	if (user.type === "Bot") {
...
function isLiveStateCurrent(live: LivePullRequest, expectedHeadSha: string): boolean {
...
export type { PrStateProblem, TrustEvaluation };
